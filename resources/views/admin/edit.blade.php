...
<div class="card">
    ...
    <form action="{{ route('admin.update',$kamar->id_kamar) }}" method="POST">
        ...
        <input type="text" name="id_kamar" value="{{ $kamar->id_kamar }}">


        <label>Nomor Kamar</label>
        <input type="number" name="nomor_kamar" value="{{ $kamar->nomor_kamar }}">
        ...
        <input type="number" name="harga_kamar" value="{{ $kamar->harga_kamar }}">
